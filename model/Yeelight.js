...
var Yeelight = /** @class */ (function () {
    ...
    Yeelight.prototype.updateState = function (status) {
        this.info = status;
        if (this.stateUpdateCallback !== undefined) {
            this.stateUpdateCallback(status);
        }
    };
    ...
    Yeelight.prototype.setRGB = function (red, green, blue, effect, duration) {
        return __awaiter(this, void 0, void 0, function () {
            var packet;
            var rgbValue = (red * 65536) + (green * 256) + blue;
            return __generator(this, function (_a) {
                packet = {
                    id: Math.round(Math.random() * 1000000),
                    method: 'set_rgb',
